...
public class CartProductDetailsModel {
	private int id;
	...
	public CartProductDetailsModel(int id, String p_name, int p_unit_price, int p_quantity, String p_brand, Part p_image,String description,int cart_id,int t_price) {
		super();
		this.id = id;
		this.p_name = p_name;
	...
	public CartProductDetailsModel(){
